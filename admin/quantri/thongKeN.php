...
// Truy vấn để lấy dữ liệu doanh thu theo ngày
$query = "SELECT DATE(ngay_dat) as ngay, SUM(tong_tien) as doanh_thu 
          FROM donhang 
...
// Tính toán sự thay đổi doanh thu qua từng ngày
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Thống kê doanh thu theo ngày</h1>
